C
C Released version in Feb 2020, version 2.1.14
C
C
...
160   format('#====='/'# Generated by BPFIND release Feb 2021, version
     1 2.1.14'/'#=====')
...
c     1 bpair(i)
	   ...
	   elseif(ires3.gt.0) then
             write(81,162) ires1(i),base1(i),ires2(i),ires3
	   elseif(ires2(i).gt.0) then
             write(81,162) ires1(i),base1(i),ires2(i)
	   else
             write(81,162) ires1(i), base1(i)
	   endif
           ENDDO
         K=1
         ENDIF
